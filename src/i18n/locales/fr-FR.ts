...
export const frFR = {
  ...
  "home": {
    "selectGame": "Choisissez le jeu auquel vous souhaitez recharger",
    "selectGameParts": {
  ...
  "login": {
    ...
    "email": "Email",
    "emailNotBound": "Échec de la récupération, veuillez entrer l'email lié dans le jeu~",
  ...
  "logout": {
    ...
    "messageLine1": "Après la déconnexion, sur tous les appareils des 30 derniers jours",
    "messageLine2": "L'état de connexion sera perdu.",
  ...
  "products": {
    ...
    "howToUseVouchers": "Comment utiliser les coupons ?",
    "voucherGuide": {
      "title": "Comment utiliser les coupons ?",
      "step1": "1.Veuillez consulter les coupons achetés dans la boîte aux lettres du jeu.",
      "step2": "2.Vous pouvez voir le nombre de vos coupons en haut de l'onglet boutique du jeu. Lorsque le nombre de vos coupons atteint la quantité requise pour acheter un pack cadeau, les coupons seront utilisés en priorité pour l'achat.",
  ...
  "purchaseConfirm": {
    ...
    "paypal": "PayPal ",
    "title": "Êtes-vous sûr d'acheter via ce compte ? ",
  ...
  "serverSelect": {
    ...
    "title": "Sélectionner la région du jeu ",
  ...
  "support": {
    ...
    "description": "Veuillez envoyer vos informations détaillées par email officiel ",

...
export const enUS = {
  ...
  "errors": {
    "900400": "Internal parameter error",
    "900401": "Authentication failed",
    "900402": "Authentication expired",
    "1000000": "System error, please retry again later",
    "1000001": "System parameter error, please try again later",
    ...
    "1000009": "Code invalid",
    "1000010": "Get user login token error",
    "1000011": "Product is inactive, please try another product",
    "1000012": "The product has exceeded the purchase limit, please select another product",
  ...
  "login": {
    ...
    "loading": "Logging in...",
    "loginToStore": "Log in to Touka Store",
    ...
    "resendCodePrompt": "Please re-enter the captcha to resend the email verification code"
  },
  "logout": {
    "cancel": "Cancel",
    "confirm": "Confirm",
  ...
  "serverSelect": {
    ...
    "characterPlaceholder": "Please select a character",
    "confirm": "Confirm",
  ...
  "verification": {
    "back": "Return",
    "enterCode": "Please enter the verification code to continue",

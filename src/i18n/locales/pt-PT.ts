...
export const ptPT = {
  ...
  "header": {
    ...
    "selectGameServer": "Selecionar região do jogo",
    "greeting": "Olá",
  ...
  "login": {
    ...
    "loading": "Entrando...",
    "loginToStore": "Entrar na Touka Store",
  ...
  "serverSelect": {
    "characterLabel": "Nome do personagem ",
  ...
  "verification": {
    "back": "Voltar ",
    "enterCode": "Por favor, insira o código de verificação para continuar ",
